        ...
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
            <div class="sb-sidenav-menu">
                <div class="nav">
                    ...
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#userNav" aria-expanded="false" aria-controls="collapseLayouts">
                    ...
                    <div class="collapse" id="userNav" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="layout-static.php">Add User</a>
                            <a class="nav-link" href="layout-static.html">View Users</a>
                        </nav>
                    </div>
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#postNav" aria-expanded="false" aria-controls="postNav">
